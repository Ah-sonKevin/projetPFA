sig
  module Mixer :
    sig
      ...
      val quickload_raw :
        Unsigned.uint8 Ctypes_static.ptr -> Unsigned.uint32 -> chunk result
      ...
      val play_channel_timed : int -> chunk -> int -> int -> int result
      val play_channel : int -> chunk -> int -> int result
      val fade_in_channel_timed :
        int -> chunk -> int -> int -> int -> int result
      val fade_in_channel : int -> chunk -> int -> int -> int result
      ...
      val load_mus_type_rw :
        Tsdl.Sdl.rw_ops -> music_type -> int -> music result
      ...
      val effect_func_t :
        (int ->
         unit Ctypes_static.ptr -> int -> unit Ctypes_static.ptr -> unit)
        Ctypes.fn
      ...
      val set_panning :
        int -> Unsigned.uint8 -> Unsigned.uint8 -> unit result
